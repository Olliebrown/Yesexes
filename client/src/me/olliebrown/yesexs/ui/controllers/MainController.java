...
import me.olliebrown.yesexs.io.net.NetworkConstants;
import me.olliebrown.yesexs.misc.NopConnection;
import me.olliebrown.yesexs.misc.ResultDecoder;
import me.olliebrown.yesexs.ui.YesexsApplication;
import me.olliebrown.yesexs.ui.Settings;
import me.olliebrown.yesexs.ui.models.ConnectionType;
import me.olliebrown.yesexs.ui.services.DebuggerConnectionService;
...
public class MainController implements NetworkConstants, IController {
    ...
    public static void showMessage(String infoMessage, Alert.AlertType alertType) {
        Platform.runLater(() -> {
            ...
            alert.setTitle(YesexsApplication.APP_NAME);
            String header = null;
            switch (alertType) {
                case NONE:
                    header = "";
...
// Set expandable Exception into the dialog pane.
    ...
    public void setTitle(String title) {
        Platform.runLater(() -> {
            ...
            s.setTitle(YesexsApplication.APP_NAME + " v" + YesexsApplication.APP_VERSION +
                    (title != null ? (" - " + title) : ""));
        });
    }
