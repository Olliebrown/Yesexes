...
import me.olliebrown.yesexs.dump.*;
import me.olliebrown.yesexs.io.MappedList;
...
public class MemorySearchService extends Service<SearchResult> implements IMessageArguments {
    ...
    private class SearchTask extends Task<SearchResult> {
        ...
        protected SearchResult call() throws Exception {
            ...
            res.addresses = createList(YesexsFiles.createTempFile("addrs"));
            if (prevResult != null) {
                refineSearch();
            } else {
                fullSearch();
        ...
        MemoryDump createDump(SearchResult res, DumpRegionSupplier supplier) throws IOException {
            ...
            if (YesexsFiles.getTempDir().getFreeSpace() < supplier.getSize()) {
