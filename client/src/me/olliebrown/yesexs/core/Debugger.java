package me.olliebrown.yesexs.core;

import me.olliebrown.yesexs.misc.BreakpointFlagBuilder;
...
public class Debugger implements Commands, Closeable {
    ...
    public static final int CURRENT_PROTOCOL_VERSION = (YesexsApplication.VERSION_MAJOR << 16) | (YesexsApplication.VERSION_MINOR) << 8;
